...
seo:
  metaTitle: "Hệ thống Định vị GNSS | Phân Tích Kỹ Thuật và Ứng Dụng Hàng Hải"
  metaDescription: "Tìm hiểu chuyên sâu về công nghệ GNSS trong hàng hải, nguyên lý hoạt động, các nguồn sai số, ứng dụng đa hệ thống và yêu cầu về tính dự phòng."
---
