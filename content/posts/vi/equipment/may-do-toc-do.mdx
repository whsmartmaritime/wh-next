...
excerpt: "Phân tích chuyên sâu về công nghệ Speed Log, sự khác biệt giữa tốc độ xuyên nước (STW) và tốc độ trên mặt đất (SOG), nguyên lý hoạt động của DVL và Log Điện Từ, cùng vai trò trong điều động và hiệu suất nhiên liệu."
...
seo:
  metaTitle: "Máy Đo Tốc Độ: Kỹ Thuật DVL, Phân Biệt STW/SOG và Hiệu Suất | Wheelhouse"
  metaDescription: "Tìm hiểu sâu về Log Doppler (DVL) và Log Điện Từ, cơ chế đo lường tốc độ, các nguồn sai số và ứng dụng tối ưu hóa hiệu suất thủy động lực học của tàu."
---
...
- **Nguyên lý:** DVL phát các chùm sóng âm thanh tần số cao xuống đáy biển. Khi chùm sóng phản xạ trở lại, tần số của nó đã thay đổi (Hiệu ứng Doppler). Sự thay đổi tần số này ($\Delta f$) tỷ lệ thuận với vận tốc tương đối của tàu so với đáy biển.
  $$\Delta f = 2 \cdot f_t \cdot \frac{v \cos \theta}{c}$$
  Trong đó $f_t$ là tần số phát, $v$ là vận tốc, $\theta$ là góc của chùm tia, và $c$ là tốc độ âm thanh.
