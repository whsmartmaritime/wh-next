			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						address: {
							'@type': 'PostalAddress',
							streetAddress: aboutMessages.contact.address.streetAddress,
							addressLocality: aboutMessages.contact.address.district,
							addressRegion: aboutMessages.contact.address.city,
							addressCountry: aboutMessages.contact.address.country,
						},
						geo: {
							'@type': 'GeoCoordinates',
							latitude: 20.84433,
						...
						sameAs: [aboutMessages.contact.social.linkedin],
						serviceArea: {
							'@type': 'Place',
